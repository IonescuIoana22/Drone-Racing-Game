...
void Lab2::Init()
{
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices2 =
        {
            //VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(3, 0, 4), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(4, 0, 4), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(4, 0, 5), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 0, 5), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0));
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 0, 1));
